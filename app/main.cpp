...
{
      ::setenv("URE_MORE_TYPES", "file:///usr/lib/libreoffice/program/types/offapi.rdb", 1);
    ...
    try
    {
        ...
        OUString sInputFileName = OUString::createFromAscii("/usr/lib/libreoffice/sdk/examples/cpp/DocumentLoader/test.odt");
